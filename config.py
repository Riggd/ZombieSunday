...
SUPPLY_GOAL_MOD = 5 # SUPPLY_GOAL += SUPPLY_GOAL_MOD * level.stage
...
FIRELOB_EXPLOSION_DAMAGE = 15
FIRELOB_FIRE_DAMAGE = 5
...
FIREFORCE_FIRE_DAMAGE = 5
FIREFORCE_FIRE_DURATION = 2
