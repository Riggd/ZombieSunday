...
BOX_BG_POS = (417, 177)
BUTTON_NEXT_LEVEL_POS = (BOX_BG_POS[0] + 117, BOX_BG_POS[1] + 179)
LVL_COMPLETE_TITLE_POS = (BOX_BG_POS[0] + 94, BOX_BG_POS[1] + 22)
LVL_COMPLETE_SCORE_POS = (BOX_BG_POS[0] + 130, BOX_BG_POS[1] + 80)
...
SUPPLY_RANGE = [40,40] # [min, max].  Random amount of supplies (between min and max) you get from scavaging buildings / picking up.
SUPPLY_GOAL = 40
