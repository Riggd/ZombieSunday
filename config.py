...
HOW_TO_SCREEN_POS = (90,8)
BUTTON_BACK_TO_TITLE_POS = (905, 38)

BOX_BG_POS = (417, 177)
BOX_2_BG_POS = (417, 144)
BUTTON_NEXT_LEVEL_POS = (BOX_BG_POS[0] + 117, BOX_BG_POS[1] + 330)
BUTTON_EXIT_TO_TITLE_POS = (BOX_2_BG_POS[0] + 44, BOX_2_BG_POS[1] + 370)
LVL_COMPLETE_TITLE_POS = (BOX_2_BG_POS[0] + 37, BOX_2_BG_POS[1] + 20)
LVL_COMPLETE_KILLS_POS = (BOX_2_BG_POS[0] + 110, BOX_2_BG_POS[1] + 120)
LVL_COMPLETE_GAME_SCORE_POS = (BOX_2_BG_POS[0] + 110, BOX_2_BG_POS[1] + 170)
LVL_COMPLETE_TIME_SCORE_POS = (BOX_2_BG_POS[0] + 110, BOX_2_BG_POS[1] + 220)
LVL_COMPLETE_TOTAL_SCORE_POS = (BOX_2_BG_POS[0] + 110, BOX_2_BG_POS[1] + 270)
...
ZOMBIE_MAX = 5
ZOMBIE_SPAWN_RATE = 4
ZOMBIE_ATTACHMENT_DROP_CHANCE = .6
...
# ITEM CONFIG
ITEM_AMMO_ROUNDS = 40
ITEM_AMMO_RANGE = [12, 20, 100]
ITEM_ATTACHMENT_RANGE = [50, 100, 100]
...
FIREFIRE_DAMAGE = 5
FIREFIRE_FIRE_DAMAGE = 5
FIREFIRE_FIRE_DURATION = 2
...
FIRELOB_VSPEED = -500
FIRELOB_GRAVITY = 20
FIRELOB_ADD_PLAYER_SPEED = False
FIRELOB_EXPLOSION_DURATION = 1
FIRELOB_EXPLOSION_DAMAGE = 30
...
LOB_VSPEED = -500
LOB_GRAVITY = 20
LOB_ADD_PLAYER_SPEED = False
LOB_EXPLOSION_DURATION = 1
LOB_EXPLOSION_DAMAGE = 30
...
LOBLOB_VSPEED = -500
LOBLOB_GRAVITY = 20
LOBLOB_ADD_PLAYER_SPEED = False
LOBLOB_EXPLOSION_DURATION = 1
LOBLOB_EXPLOSION_DAMAGE = 75
